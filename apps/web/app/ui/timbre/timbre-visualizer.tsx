...
interface TimbreVisualizerProps {
    timbre: Timbre & {
        shelves: (Shelf & { partitions: Partition[] })[];
    };
}
                        ...
                        >
                            ...
                            {shelf.partitions.map((item) => (
                                <div
                                    ...
                                    title={`${item.name} (${item.volumeLevel}) - GN ${item.assignedGN} @ ${item.assignedDepth}mm`}
                                >
